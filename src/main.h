...
static const int64_t MAX_MONEY = 160000000 * COIN; //newtodo1
...
public:
    ...
    {
        // Lordcoin: the coin stake transaction is marked with the first output empty
...
public:
    ...
    // Lordcoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // Lordcoin: two types of block: proof-of-work or proof-of-stake
    ...
    // Lordcoin: get max transaction timestamp
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // Lordcoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // Lordcoin: block index flags
    enum  
    {
