...
const QString BITCOIN_IPC_PREFIX("Lordcoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click Lordcoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start Lordcoin: click-to-pay handler");
    else
...
{
    // clicking on Lordcoin: URLs creates FileOpen events on the Mac:
